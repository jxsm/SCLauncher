  ...
  private async loadSources() {
    try {
      ...
      this.sources.value = [
        ...
        {
          id: 'suancaixianyu-online',
          type: 'online-mods',
          name: '生存战争中文社区',
          description: '生存战争中文社区联机模组仓库',
          icon: '',
          enabled: true,
          isDefault: true, // 设置为联机模组的默认源
          api: {
            baseUrl: 'https://m.suancaixianyu.cn',
            endpoint: {
              method: 'GET',
              url: '/api/post/list?type=2&orderType=1&fileTypes=8&page={page}&limit={limit}',
              headers: {},
              pagination: {
                pageParam: 'page',
                limitParam: 'limit',
            ...
            search: {
              method: 'GET',
              url: '/api/post/list?type=2&orderType=1&fileTypes=8&title={query}&page={page}&limit={limit}',
              headers: {},
              pagination: {
                pageParam: 'page',
                limitParam: 'limit',
        ...
        {
          id: 'suancaixianyu-skins',
          type: 'skins',
          name: '生存战争中文社区',
          description: '生存战争中文社区皮肤仓库',
          icon: '',
          enabled: true,
          isDefault: true,
          api: {
            ...
            endpoint: {
              method: 'GET',
              url: '/api/post/list?type=2&orderType=3&fileTypes=4&page={page}&limit={limit}',
              headers: {},
              pagination: {
                pageParam: 'page',
                limitParam: 'limit',
            ...
            search: {
              method: 'GET',
              url: '/api/post/list?type=2&orderType=3&fileTypes=4&title={query}&page={page}&limit={limit}',
              headers: {},
              pagination: {
                pageParam: 'page',
                limitParam: 'limit',
        ...
        {
          id: 'suancaixianyu-textures',
          type: 'textures',
          name: '生存战争中文社区',
          description: '生存战争中文社区材质仓库',
          icon: '',
          enabled: true,
          isDefault: true,
          api: {
            ...
            endpoint: {
              method: 'GET',
              url: '/api/post/list?type=2&orderType=3&plateId=2&fileTypes=3&page={page}&limit={limit}',
              headers: {},
              pagination: {
                pageParam: 'page',
                limitParam: 'limit',
            ...
            search: {
              method: 'GET',
              url: '/api/post/list?type=2&orderType=3&fileTypes=3&title={query}&page={page}&limit={limit}',
              headers: {},
              pagination: {
                pageParam: 'page',
                limitParam: 'limit',
      ...
      try {
        ...
        if (customSources && Array.isArray(customSources)) {
          ...
          const builtinSourceIds = ['suancaixianyu', 'suancaixianyu-online', 'suancaixianyu-saves', 'suancaixianyu-furniture', 'suancaixianyu-skins', 'suancaixianyu-textures']
      ...
      // 优先尊重用户在配置文件中设置的默认源
      const sourceTypes = ['mods', 'online-mods', 'savegames', 'furniture', 'textures', 'skins'] as const
