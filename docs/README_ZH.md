...
- **多语言支持** - 支持8种语言（简体中文、英语、俄语、葡萄牙语、印地语、印尼语、阿拉伯语、西班牙语）
...
- **[生存战争中文社区下载源配置说明](suancaixianyu-config-explanation.md)** - 如何使用新的v2格式配置自定义模组下载源
- **[模组下载源配置示例](mod-source-config-examples.md)** - 详细的下载源配置示例和说明
